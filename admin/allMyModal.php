                                            ...
                                            <div class="collapse show" id="collapseAddCategories">
                                                <div class="card-body">
                                                    ...
                                                    <form class="user" role="form" id="form_add_categories" action="controllers/traitement.php?categories=add" method="post">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" id="titre_categories" name="titre_categories" aria-describedby="titre_categories" placeholder="Titre Catégorie">
                                                        </div>

                                                        <div class="form-group">
                                                            <textarea name="desc_categories" class="form-control" id="desc_categories" aria-describedby="desc_categories" cols="30" rows="5" placeholder="Description Catégorie"></textarea>
                                                        </div>
                                        ...
                                        <div class="card shadow mb-4">
                                            ...
                                            <div class="collapse show" id="collapseAddCategories">
                                                <div class="card-body">
                                                    ...
                                                    <form class="user" role="form" id="form_add_tag" action="controllers/traitement.php?tag=add" method="post">
                                                        <div class="form-group">
                                                            <label for="titre_tag"></label><input type="text" class="form-control" id="titre_tag" name="titre_tag" aria-describedby="titre_tag" placeholder="Titre du Tag">
                                                        </div>
